...
def main():
    ...
    res_df.to_csv('2026_2nd_round_predictions.csv', index=False)
    print("Successfully predicted 2026 2nd Round matches and saved to 2026_2nd_round_predictions.csv")
