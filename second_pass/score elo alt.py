...
# (Assuming alt 1 and alt 2 are in the csv)
...
# =====================================================
# VISUALIZE FITTED LINE (Holding Alts at 0)
# =====================================================

x_line = np.linspace(X["elo_diff"].min(), X["elo_diff"].max(), 1000)

# Create a DataFrame for prediction matching feature names and keeping alts neutral
